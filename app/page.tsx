    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <section className="text-center mb-16 mt-8">
        ...
        <p className="text-base text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-6">
          Learn, build, and master software development. Deep dives into
          programming concepts, tutorials, and best practices.
        </p>
      ...
      <section className="mb-16 max-w-4xl mx-auto">
        <div className="p-8 border border-gray-200 dark:border-gray-800 rounded-md bg-white dark:bg-gray-900/50">
          ...
          <p className="text-base text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            ...
            with extensive experience building scalable web applications across
            retail, insurance, government, and financial sectors. Currently
            based in Bentonville, Arkansas, I've worked with diverse technology
            stacks and contributed to all facets of application development.
          </p>
            ...
            <div className="space-y-5">
              ...
              <div className="border-l-2 border-gray-300 dark:border-gray-700 pl-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Currently working as a Senior Software Engineer, contributing
                  to large-scale retail technology solutions and enterprise
                  applications at one of the world's largest retailers.
                </p>
              </div>
              ...
              <div className="border-l-2 border-gray-300 dark:border-gray-700 pl-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Developed cloud-based applications with a focus on code
                  quality and best practices. Specialized in{' '}
                  <strong className="text-gray-900 dark:text-white">
              ...
              <div className="border-l-2 border-gray-300 dark:border-gray-700 pl-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Worked on cloud application development for state government
                  services, contributing to public-facing applications and
                  internal systems. Gained experience working with government
              ...
              <div className="border-l-2 border-gray-300 dark:border-gray-700 pl-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Developed and maintained multiple high-impact applications
                  including Styleguide (design system), amfam.com (corporate
                  website), rewards applications, and premium calculation tools.
              ...
              <div className="border-l-2 border-gray-300 dark:border-gray-700 pl-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Worked on web applications for asset management, contributing
                  to financial technology solutions and gaining valuable
      ...
      <section className="mt-12 p-6 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-md text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-5 max-w-xl mx-auto">
          New articles and tutorials published regularly. Follow along on the
