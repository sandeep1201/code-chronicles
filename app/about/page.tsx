    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg dark:prose-dark max-w-none">
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
          A platform for learning in public, sharing knowledge, and building a
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          Code Chronicles exists to make learning software development more
          accessible, practical, and enjoyable. By documenting the learning
          journey and sharing insights, we create a resource that helps others
          avoid common pitfalls and accelerate their growth.
        </p>
        ...
        <ul className="space-y-3 text-gray-700 dark:text-gray-300">
          <li className="flex items-start">
            ...
            <span>
              <strong>Learn in Public</strong> - Real learning journey, not
              polished perfection
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">✓</span>
            <span>
              <strong>Interactive Content</strong> - Code you can run, concepts
              you can explore
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">✓</span>
            <span>
              <strong>Practical Focus</strong> - Real-world examples and
              applications
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">✓</span>
            <span>
              <strong>Continuously Updated</strong> - Content evolves as
