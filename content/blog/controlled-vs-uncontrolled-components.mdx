...
excerpt: >-
  My form inputs were sometimes controlled, sometimes uncontrolled, and React
  kept warning me. Here's how to design components that make the control model
  obvious—and avoid the bugs that come from mixing them.
